...
| `pleiades-houses::HouseRequest` | house-observer requests only | not a time-scale conversion surface | uses the observer for house calculations but does not infer body-position time conversion |

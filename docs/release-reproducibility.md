...
- the release notes file summarizes release-specific coverage, validation reference points, known limitations, and the current API stability / deprecation-policy snapshot, and the release summary gives a compact one-screen overview of the same release posture,

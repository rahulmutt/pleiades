...
The validation tool can also render the full compatibility profile, the compact profile summary, verify the release compatibility profile against the canonical catalogs, render the release notes, release-notes summary, release checklist, release-checklist summary, release summary, API stability summary, backend matrix summary, artifact summary, and validation summary directly when you only need the individual maintainer-facing artifacts, and the user-facing CLI mirrors the release-notes, release-notes-summary, release-checklist, release-checklist-summary / checklist-summary, release-summary, verify-compatibility-profile, verify-release-bundle, api-stability-summary, backend-matrix-summary / matrix-summary, artifact-summary / artifact-posture-summary, report / generate-report, and validation-report-summary / validation-summary / report-summary renderers too; the compact compatibility-profile-summary and release-notes-summary views now also cross-reference the backend-matrix-summary, api-stability-summary, validation-report-summary / validation-summary / report-summary, and packaged-artifact summary views alongside the release-checklist and verification hops, so maintainers can jump between the compact release surfaces without changing the underlying compatibility profile; the compact compatibility-profile-summary view now also points to `verify-release-bundle` for a direct staged-bundle audit hop, the release-checklist summary now also points back to the compact release-summary view for a quicker one-screen audit hop and the `verify-release-bundle` verifier for the staged bundle audit, and the compact release summary now also includes the custom-definition label counts that keep the release posture self-describing, a packaged-artifact cross-reference, and the compact validation-report-summary / validation-summary / report-summary alias in its summary-view list:

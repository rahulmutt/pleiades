...
- `ChartSnapshot` now offers lookup helpers for body, house, and house-scoped placement questions plus a retrograde summary so downstream chart reports can ask higher-level questions without re-scanning placements manually,

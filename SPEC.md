...
4. a compressed representation optimized for common use in **1900-2100 CE** by default (wider windows opt-in)
...
- define a compressed data representation optimized for **1900-2100 CE** by default (wider windows opt-in)
...
- [spec/data-compression.md](spec/data-compression.md) — compressed artifact format and generation pipeline (1900-2100 CE default, wider windows opt-in)
...
8. **Data-range optimization**: packaged compressed data is optimized for 1900-2100 CE by default (wider windows opt-in via `generate-artifact`), while some live or algorithmic backends may support broader ranges.
...
- distribute a compressed ephemeris dataset covering 1900-2100 CE by default (wider windows opt-in)
...
| Compressed representation optimized for common use in 1900-2100 CE by default (wider windows opt-in) | [spec/data-compression.md](spec/data-compression.md), [spec/backends.md](spec/backends.md), [spec/architecture.md](spec/architecture.md) |

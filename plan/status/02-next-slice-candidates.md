...
- The validation-report and release-summary layers now also surface the 2451918 and 2451919 boundary slices explicitly.
...
- The CLI runtime also covers the 1500 selected-body, 1750 major-body interior, 1900 selected-body, and 2360234 major-body interior aliases, so the current alias-parity slice is fully exercised in the CLI and validation fronts.

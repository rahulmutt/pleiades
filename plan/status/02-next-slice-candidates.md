...
- The CLI runtime also covers the 1500 selected-body, 1750 major-body interior, 1900 selected-body, 2360233 major-body boundary, 2360234 major-body interior, and 2378499 major-body boundary aliases, so the current alias-parity slice is fully exercised in the CLI and validation fronts.

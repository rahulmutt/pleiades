...
1. extend the reproducible generated complete-table path beyond the first Earth binary table slice, so the remaining VSOP87B bodies can also be regenerated deterministically from public inputs;

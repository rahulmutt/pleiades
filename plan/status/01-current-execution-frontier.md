...
Small preparatory backend-semantics increments have landed: supported planetary results now include deterministic central-difference mean-motion estimates, so chart/report helpers can classify direct/retrograde motion, and direct observer-bearing requests to the geocentric VSOP87/ELP placeholders now fail explicitly instead of implying topocentric support. Full VSOP87 coefficient ingestion remains outstanding.

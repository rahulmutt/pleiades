...
- selected asteroid reporting now also surfaces a broader source-backed window set (20 samples across 5 bodies and 4 epochs) alongside the exact J2000 slice for provenance and validation, and those source evidence/window summaries now validate and fail closed on drift;

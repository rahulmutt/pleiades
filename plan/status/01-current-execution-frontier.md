...
1. extend the reproducible generated complete-table path beyond the current Earth, Mercury, Venus, and Mars binary table slices, so the remaining VSOP87B bodies can also be regenerated deterministically from public inputs;

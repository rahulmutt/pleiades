...
1. replace the checked-in truncated Earth/Mercury coefficient slices with a reproducible generated complete-table path;
2. extend the coefficient representation to Venus and the outer major planets;

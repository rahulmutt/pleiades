...
1. replace the remaining checked-in truncated Mercury/Venus/Mars/Jupiter/Saturn/Uranus/Neptune coefficient slices with a reproducible generated complete-table path; the Earth/Sun path already uses the vendored full IMCCE/CELMECH VSOP87B source file;

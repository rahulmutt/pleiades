...
| --- | --- |
| Phase 1 — Production reference backend and corpus | `requirements.md` FR-7/FR-8/NFR-3/NFR-4, `backends.md`, `backend-trait.md`, `validation-and-testing.md` reference comparison/release gates |
| Phase 2 — Release-grade compressed ephemeris | `requirements.md` FR-9/NFR-2/NFR-4, `data-compression.md`, `backends.md` packaged-data backend |

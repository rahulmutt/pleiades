...
- CLI/validation commands for compatibility profiles, backend matrices, API stability posture, validation reports, artifact summaries, release notes, release checklists, workspace audits, release summaries, and release bundle generation/verification;
...
- Generate backend capability matrix, API stability posture, validation report, benchmark report, artifact summary, release notes, release checklist, and release summary.

...
- [x] The source-label appendix now also surfaces the PVR Pushya-paksha / True Pushya, J. N. Bhasin, Lahiri (VP285), Krishnamurti (VP291), Sheoran, and remaining mean-sun / galactic-reference source forms that users see in Swiss Ephemeris-style interoperability tables, keeping the release profile searchable by the labels that appear in upstream docs.

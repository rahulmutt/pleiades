...
- [x] `pleiades-core::ChartSnapshot` now offers direct body lookup, sign lookup, house lookup, sign-scoped and house-scoped placement iteration, and retrograde-summary helpers, and chart rendering emits a retrograde-body summary when motion data is available.

...
- [x] `pleiades-core::ChartSnapshot` now offers direct body lookup, house lookup, house-scoped placement iteration, and retrograde-summary helpers, and chart rendering emits a retrograde-body summary when motion data is available.

...
- [x] Babylonian (Huber), Galactic Equator (IAU 1958), True Pushya, Djwhal Khul, and Valens Moon now carry explicit sidereal-offset reference metadata, and the compatibility profile notes them as exceptions to the broader ayanamsa-metadata gap.

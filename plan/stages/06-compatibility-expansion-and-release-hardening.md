...
- [x] The compatibility profile now also renders a source-label appendix for the built-in house systems, keeping the release-facing house interoperability map searchable alongside the ayanamsa appendix.

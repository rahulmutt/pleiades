...
- [x] The benchmark corpus now uses seven epochs across the 1500-2500 target window instead of the earlier three-epoch slice, including additional mid-window coverage so the validation report carries a stronger representative workload for Stage 6 release hardening.

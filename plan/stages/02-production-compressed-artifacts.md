...
- Keep raw source inputs, normalized intermediate data, generated manifests, and distributable compressed artifacts separated; the regeneration command now supports manifest and normalized-intermediate summary sidecars so the output split can be exercised directly.

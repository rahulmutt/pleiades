...
- `pleiades-jpl` provides a checked-in JPL Horizons fixture/snapshot backend, exact fixture epochs, interpolation transparency evidence, equatorial reconstruction, expanded selected-asteroid rows (including the added 2001-01-07 boundary slice and the 2003-12-27 asteroid slice for Ceres, Pallas, Juno, and Vesta), a selected-asteroid boundary-day summary at JD 2451914.5, expanded reference-corpus coverage across 174 rows, 15 bodies, and 15 epochs with a 2451910.5 high-curvature boundary sample, and expanded interpolation-quality reference coverage across 100 samples, 10 bodies, and 12 epochs around JD 2451910.5; its reference corpus now also exposes the 2453000.5 and 2451914.5 boundary-day extensions for the major-body high-curvature slice, the selected-asteroid batch-parity slice now has a direct CLI path in both CLIs, and the comparison/reference snapshot manifest summaries now also have direct CLI paths for provenance inspection, but it is not yet a broad production JPL reader/corpus.

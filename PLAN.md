...
| --- | --- | --- |
| 1. Production compressed data | Active | Highest leverage next work: continue reducing the remaining high-error bodies after the mixed-order quadratic-window and linear-span slices, then tighten thresholds and benchmarks. |

...
| --- | --- | --- |
| 1. Production compressed data | Active | Highest leverage next work: continue reducing the remaining outlier bodies after the mixed-order quadratic-window slice, then tighten thresholds and benchmarks. |

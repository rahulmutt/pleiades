...
- `pleiades-jpl` with checked-in JPL Horizons snapshot/hold-out fixtures, new 1500-01-01 early-boundary coverage for Sun, Moon, Mercury, and Venus, dedicated 1500-01-01, 1600-01-11, 1750-01-01, 1800-01-03, 1900-01-01, and 2200-01-01 selected-body boundary report surfaces, a 2500-01-01 selected-body boundary slice for Mars, Mercury, Moon, Sun, and Venus, an added 1750-01-01 interior boundary slice for Sun through Neptune, an added 2360234.5 interior comparison slice now exposed through a dedicated report surface, an added 2451915.25/2451915.75 high-curvature hold-out window for Sun, Moon, Mercury, and Venus, 2451913.5/2451917.5/2451919.5 major-body boundary report surfaces plus a 2451920.5 interior reference slice, an added 2453000.5 major-body boundary summary promoted into the top-level reference snapshot summary, an epoch-specific 2451914 major-body pre-bridge alias and an epoch-specific 2451915 major-body bridge alias, selected asteroid rows, interpolation transparency evidence, provenance summaries, and validation helpers; it is not yet a broad production JPL reader/corpus;

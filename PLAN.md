...
- `pleiades-jpl` with checked-in JPL Horizons snapshot/hold-out fixtures, new 1500-01-01 early-boundary coverage for Sun, Moon, Mercury, and Venus, dedicated 1500-01-01, 1600-01-11, and 1900-01-01 selected-body boundary report surfaces, a 2500-01-01 selected-body boundary slice for Mars, Mercury, Moon, Sun, and Venus, an added 1750-01-01 interior boundary slice for Sun through Neptune, an added 2200-01-01 interior selected-body slice for Sun, Moon, Mercury, and Venus, an added 2360234.5 interior comparison slice, an added 2451915.25/2451915.75 high-curvature hold-out window for Sun, Moon, Mercury, and Venus, a 2451920.5 interior reference slice, selected asteroid rows, interpolation transparency evidence, provenance summaries, and validation helpers; it is not yet a broad production JPL reader/corpus;

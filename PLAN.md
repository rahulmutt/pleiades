...
- `pleiades-jpl` provides a checked-in JPL Horizons fixture/snapshot backend, exact fixture epochs, interpolation transparency evidence, equatorial reconstruction, expanded selected-asteroid rows, a selected-asteroid boundary-day summary at JD 2451914.5, and expanded interpolation-quality reference coverage across 70 samples, 10 bodies, and 9 epochs around JD 2451910.5; its reference corpus now also exposes the 2451914.5 boundary-day extension for the major-body high-curvature slice, but it is not yet a broad production JPL reader/corpus.

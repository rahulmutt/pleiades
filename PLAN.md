...
- the backend matrix and release summary now also surface the production-generation source revision line, keeping the provenance block visible alongside the validated corpus-shape and manifest summaries;

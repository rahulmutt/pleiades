...
- `pleiades-jpl` provides a checked-in JPL Horizons fixture/snapshot backend, exact fixture epochs, interpolation transparency evidence, equatorial reconstruction, selected asteroid rows, and expanded interpolation-quality reference coverage around JD 2451910.5; it is not yet a broad production JPL reader/corpus.

...
| --- | --- | --- |
| 1. Production compressed data | Active | Highest leverage next work: continue reducing the remaining longitude outliers after the adjacent-linear-span slice, then tighten thresholds and benchmarks. |

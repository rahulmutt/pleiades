...
- the checked-in independent-hold-out fixture now includes selected-asteroid and major-body bridge rows at JD 2451915.5, and now also extends the selected-asteroid outer boundary to JD 2634167 for asteroid:433-Eros and asteroid:99942-Apophis in addition to the existing JD 2378498.5, JD 2451545, JD 2451917.5, JD 2453000.5, and JD 2500000 anchors, so the production-generation boundary summaries now reflect the expanded 79-row, 16-body, 15-epoch hold-out slice;

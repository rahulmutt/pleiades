...
pub const fn current_compatibility_profile() -> CompatibilityProfile {
    CompatibilityProfile {
        profile_id: "pleiades-compatibility-profile/0.6.20",
        ...
        release_notes: &[
            ...
            "The compatibility profile now also renders a source-label appendix entry for Raman so the B. V. Raman spelling is searchable alongside the other baseline ayanamsa labels.",
...
mod tests {
    ...
    fn display_lists_release_sections() {
        ...
        assert!(rendered.contains("B. V. Raman -> Raman"));

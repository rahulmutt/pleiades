...
mod tests {
    ...
    fn display_lists_release_sections() {
        ...
        assert!(rendered.contains("Pullen SD (Neo-Porphyry) table of houses, Pullen SD (Neo-Porphyry), Neo-Porphyry, Pullen (Sinusoidal Delta), Pullen SD (Sinusoidal Delta), Pullen sinusoidal delta -> Pullen SD"));

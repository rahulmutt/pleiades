...
pub const fn current_compatibility_profile() -> CompatibilityProfile {
    CompatibilityProfile {
        ...
        known_gaps: &[
            ...
            "Additional Swiss Ephemeris ayanamsa modes remain scheduled for future release-breadth batches, even after adding the Hipparchus, Babylonian house/sissy/true-geoc/true-topc/true-obs/house-obs, Galactic, True Pushya, Djwhal Khul, JN Bhasin, mean-sun, VP285/VP291, and the backfilled True Sheoran, Rgilbrand, and Mula/Wilhelm reference modes to the catalog.",

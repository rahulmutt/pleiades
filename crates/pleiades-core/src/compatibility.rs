...
pub const CURRENT_COMPATIBILITY_PROFILE_ID: &str = "pleiades-compatibility-profile/0.6.27";
...
pub const fn current_compatibility_profile() -> CompatibilityProfile {
    CompatibilityProfile {
        ...
        release_notes: &[
            ...
            "The True Citra entry now also accepts the True Citra Paksha and True Chitrapaksha spellings, keeping the release-facing source-label appendix aligned with common interoperability wording.",

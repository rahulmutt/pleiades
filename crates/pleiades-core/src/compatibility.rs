...
pub const CURRENT_COMPATIBILITY_PROFILE_ID: &str = "pleiades-compatibility-profile/0.6.57";
...
mod tests {
    ...
    fn display_lists_release_sections() {
        ...
        assert!(rendered.contains(
            "KP, Krishnamurti (Swiss), Krishnamurti Paddhati, KP ayanamsa -> Krishnamurti"
        ));

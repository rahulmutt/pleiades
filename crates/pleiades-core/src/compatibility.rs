...
pub const CURRENT_COMPATIBILITY_PROFILE_ID: &str = "pleiades-compatibility-profile/0.6.46";
...
mod tests {
    ...
    fn display_lists_release_sections() {
        ...
        assert!(rendered.contains("source-label appendix entries for Lahiri / Chitrapaksha, True Chitra / Chitra, Fagan/Bradley, Fagan Bradley / Fagan-Bradley, Usha Shashi, and the Yukteshwar / Shri Yukteshwar transliterations"));

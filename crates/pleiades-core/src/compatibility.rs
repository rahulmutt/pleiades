...
pub const CURRENT_COMPATIBILITY_PROFILE_ID: &str = "pleiades-compatibility-profile/0.6.112";
...
mod tests {
    ...
    fn display_lists_release_sections() {
        ...
        assert!(rendered.contains("Pullen SD (Neo-Porphyry) table of houses, Pullen SD (Neo-Porphyry), Neo-Porphyry, Pullen (Sinusoidal Delta), Pullen sinusoidal delta -> Pullen SD"));
        assert!(rendered.contains("Pullen SR"));
        assert!(rendered.contains(
            "Pullen SR (Sinusoidal Ratio) table of houses, Pullen SR (Sinusoidal Ratio), Pullen (Sinusoidal Ratio), Pullen sinusoidal ratio -> Pullen SR"
        ));
        assert!(rendered.contains(
            "Babylonian/Kugler 1, Babylonian Kugler 1, Babylonian 1 -> Babylonian (Kugler 1)"
        ));

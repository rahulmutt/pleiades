...
pub const CURRENT_COMPATIBILITY_PROFILE_ID: &str = "pleiades-compatibility-profile/0.7.10";
...
#[cfg(test)]
const CURRENT_COMPATIBILITY_PROFILE_CONTENT_CHECKSUM: u64 = 0x1079_8010_f665_2b7d;

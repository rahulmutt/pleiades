...
mod tests {
    ...
    fn summary_commands_render_compact_reports() {
        ...
        assert_eq!(
            ...
            super::validate_render_cli(&["comparison-body-class-tolerance-posture-summary"])
                .expect(
                    "comparison body-class tolerance posture summary should match validate CLI"
                )
        );
        ...
        assert_eq!(
            render_cli(&["reference-snapshot-2500000-selected-asteroid-source-summary"]).expect(
                "reference snapshot 2500000 selected asteroid source summary should render"
            ),
        ...
        assert_eq!(
            render_cli(&["reference-snapshot-2634167-selected-asteroid-source-summary"]).expect(
                "reference snapshot 2634167 selected asteroid source summary should render"
            ),
    ...
    fn help_text_lists_the_packaged_lookup_epoch_policy_summary_command() {
        ...
        assert!(
            help.contains("packaged-frame-parity         Alias for packaged-frame-parity-summary")
        );
        assert!(help.contains(

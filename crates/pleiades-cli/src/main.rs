...
mod tests {
    ...
    fn profile_command_renders_catalogs() {
        ...
        assert!(rendered.contains("X, Meridian houses, Meridian table of houses, ARMC, Axial Rotation, Axial rotation system, Zariel, X axial rotation system/ Meridian houses -> Meridian"));

...
mod tests {
    ...
    fn summary_commands_render_compact_reports() {
        ...
        assert!(regenerated.contains("generation policy: overlapping same-body quadratic spans"));

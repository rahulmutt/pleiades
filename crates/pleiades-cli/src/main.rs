...
mod tests {
    ...
    fn summary_commands_render_compact_reports() {
        ...
        assert!(house_validation_summary.contains("House validation corpus: 7 scenarios"));
    ...
    fn unknown_command_is_rejected() {
        ...
        assert!(error.contains("production-generation-summary  Print the compact production-generation coverage summary"));
        assert!(error.contains("production-generation-boundary-source-summary  Print the compact production-generation boundary source summary"));
        assert!(error.contains("production-generation-boundary-window-summary  Print the compact production-generation boundary windows summary"));
        assert!(error.contains("production-generation-source-summary  Print the compact production-generation source summary"));
        ...
        assert!(error.contains("reference-snapshot-1749-major-body-boundary-summary  Print the compact reference 1749 major-body boundary evidence summary"));
        assert!(error.contains("reference-snapshot-early-major-body-boundary-summary  Print the compact reference early major-body boundary evidence summary"));
        assert!(error.contains("reference-snapshot-1800-major-body-boundary-summary  Print the compact reference 1800 major-body boundary evidence summary"));
        assert!(error.contains("reference-snapshot-2500-major-body-boundary-summary  Print the compact reference 2500 major-body boundary evidence summary"));
        assert!(error.contains("reference-snapshot-major-body-boundary-summary  Print the compact reference major-body boundary evidence summary"));
        assert!(error.contains(
            "major-body-boundary-summary  Alias for reference-snapshot-major-body-boundary-summary"
        ));
        assert!(error.contains("reference-snapshot-mars-jupiter-boundary-summary  Print the compact reference Mars/Jupiter boundary evidence summary"));
        assert!(error.contains("mars-jupiter-boundary-summary  Alias for reference-snapshot-mars-jupiter-boundary-summary"));
        assert!(error.contains("reference-snapshot-mars-outer-boundary-summary  Print the compact reference Mars outer-boundary evidence summary"));
        assert!(error.contains(
            "mars-outer-boundary-summary  Alias for reference-snapshot-mars-outer-boundary-summary"
        ));
        ...
        assert!(error.contains("reference-snapshot-selected-asteroid-bridge-summary  Print the compact selected-asteroid bridge evidence summary"));
        assert!(error.contains("selected-asteroid-bridge-summary  Alias for reference-snapshot-selected-asteroid-bridge-summary"));
        assert!(error.contains("reference-snapshot-selected-asteroid-terminal-boundary-summary  Print the compact selected-asteroid terminal boundary evidence summary"));
        assert!(error.contains("selected-asteroid-terminal-boundary-summary  Alias for reference-snapshot-selected-asteroid-terminal-boundary-summary"));
        ...
        assert!(error.contains("boundary-epoch-coverage-summary  Alias for reference-snapshot-boundary-epoch-coverage-summary"));
        assert!(error.contains("reference-snapshot-sparse-boundary-summary  Print the compact reference sparse boundary day summary"));
        assert!(error.contains(
            "sparse-boundary-summary  Alias for reference-snapshot-sparse-boundary-summary"
        ));
        assert!(error.contains("independent-holdout-source-window-summary  Print the compact independent hold-out source windows summary"));
        assert!(error.contains("independent-holdout-source-summary  Print the compact independent hold-out source summary"));
        assert!(error.contains(
            "house-validation-summary   Print the compact house-validation corpus summary"
        ));
        assert!(error.contains(
        ...
        assert!(error.contains("delta-t-policy-summary   Print the compact Delta T policy summary"));
        assert!(error.contains("delta-t-policy         Alias for delta-t-policy-summary"));
        assert!(
            error.contains("observer-policy-summary  Print the compact observer policy summary")
        );
        assert!(error.contains("observer-policy        Alias for observer-policy-summary"));
        assert!(error.contains(
            "apparentness-policy-summary  Print the compact apparentness policy summary"
        ));
        assert!(error.contains("apparentness-policy     Alias for apparentness-policy-summary"));
        assert!(error.contains("frame-policy-summary   Print the compact frame-policy summary"));
        assert!(error.contains("frame-policy           Alias for frame-policy-summary"));
        assert!(error.contains("mean-obliquity-frame-round-trip-summary  Print the compact mean-obliquity frame round-trip summary"));
        assert!(error.contains("release-profile-identifiers-summary  Print the compact release-profile identifiers summary"));
        assert!(error.contains(
            "request-surface-summary  Print the compact request-surface inventory summary"
        ));
        assert!(error.contains("request-surface         Alias for request-surface-summary"));

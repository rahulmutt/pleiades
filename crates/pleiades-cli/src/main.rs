...
mod tests {
    ...
    fn summary_commands_render_compact_reports() {
        ...
        assert!(release_summary.contains("coverage=Luminaries: backend family=composite, profile=phase-1 full-file VSOP87B planetary evidence, bodies=Moon, Sun, samples="));

...
pub(crate) const DELUCE_COEFFS: [f64; 4] = [
    2.781575277442e1,
    1.396878320924e0,
    3.059011257009e-4,
    7.253107131446e-9,
];
pub(crate) const BABYLONIANKUGLER1_COEFFS: [f64; 4] = [
    2.353363986390e1,
    1.396877045876e0,
    3.058417200716e-4,
    7.880854111415e-9,
];
pub(crate) const BABYLONIANKUGLER2_COEFFS: [f64; 4] = [
    2.493363986390e1,
    1.396877045876e0,
    3.058417201569e-4,
    7.880852659688e-9,
];
pub(crate) const BABYLONIANKUGLER3_COEFFS: [f64; 4] = [
    2.578363986390e1,
    1.396877045876e0,
    3.058417200716e-4,
    7.880868628683e-9,
];
pub(crate) const BABYLONIANHUBER_COEFFS: [f64; 4] = [
    2.473363986390e1,
    1.396877045876e0,
    3.058417201569e-4,
    7.880906373579e-9,
];
pub(crate) const BABYLONIANETAPISCIUM_COEFFS: [f64; 4] = [
    2.452252793528e1,
    1.396876661735e0,
    3.058245917305e-4,
    8.071047739142e-9,
];
pub(crate) const BABYLONIANALDEBARAN_COEFFS: [f64; 4] = [
    2.475892388390e1,
    1.396877045876e0,
    3.058417201203e-4,
    7.880710390465e-9,
];
pub(crate) const HIPPARCHUS_COEFFS: [f64; 4] = [
    2.024778809429e1,
    1.396876681587e0,
    3.058254687196e-4,
    8.061170190192e-9,
];
pub(crate) const BABYLONIANBRITTON_COEFFS: [f64; 4] = [
    2.461575277442e1,
    1.396878320925e0,
    3.059011256887e-4,
    7.253069386550e-9,
];
pub(crate) const VALENSMOON_COEFFS: [f64; 4] = [
    2.279560929939e1,
    1.396880089038e0,
    3.059911244107e-4,
    6.393172423444e-9,
];
pub(crate) const LAHIRIVP285_COEFFS: [f64; 4] = [
    2.386348120291e1,
    1.396881534321e0,
    3.060730389978e-4,
    5.702090959635e-9,
];
pub(crate) const KRISHNAMURTIVP291_COEFFS: [f64; 4] = [
    2.378036495719e1,
    1.396881595131e0,
    3.060766854084e-4,
    5.673158045088e-9,
